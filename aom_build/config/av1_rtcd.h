...
void av1_nn_predict_sse3( const float *input_nodes, const NN_CONFIG *const nn_config, float *const output);
RTCD_EXTERN void (*av1_nn_predict)( const float *input_nodes, const NN_CONFIG *const nn_config, float *const output);
...
double compute_cross_correlation_avx2(unsigned char *im1, int stride1, int x1, int y1, unsigned char *im2, int stride2, int x2, int y2);
...
static void setup_rtcd_internal(void)
{
    ...
    if (flags & HAS_AVX2) compute_cross_correlation = compute_cross_correlation_avx2;
